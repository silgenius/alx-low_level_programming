...
/**
 * find_node_by_index - Searches for a index in a sorted singly linked
 * list of integers
 *
 * @list: Pointer to the head of the list to search in
 * @index: The value to search for
 *
 * Return: Pointer to the first node where the index is located
 *         NULL if the value is not present or if the list is NULL
 *
 * Assumptions:
 * - The list is sorted in ascending order
